<div class="md:grid md:grid-cols-12 w-full">
  ...
  <div class="md:col-span-3 lg:col-span-4">
    <x-menu.filter.wrapper
      class="bg-white px-20 py-20 md:pr-0 md:pl-20 lg:pl-40 w-full max-w-[90%] h-full max-h-dvh fixed left-0 top-0 z-50 md:!block md:sticky md:top-14 lg:top-40 md:h-auto md:bg-transparent md:w-auto md:py-0"
      :query="$query"
      :types="$types"
      :status="$status"
      :locations="$locations"
